...
def get():
    ...
    return [
        ...
        [ # 1
            [ # 1.0
                ' - simple and slightly extensible. Developed by Jaxee.\n**Prefix:** `{0}`{1}\n\n**Did you know that...** {2}', # 1.0.0
                [ # 1.0.1
                  'General', # 1.0.1.0
            ...
            [ # 1.2
                ...
                [ # 1.2.5
                    ...
                    'Are you setting up a Console bot at the level of your server or for yourself? To select an answer, press one of the corresponding reactions.\n||_yes, we are using SQLite DB_||\n\n🏠 - at the server level\n👤 - for yourself', # 1.2.5.1
            ...
            [ # 1.15
              ...
              'Author', # 1.15.3
              'Links', # 1.15.6
              '[Invite](https://discord.com/api/oauth2/authorize?client_id=901352871071715408&permissions=8&scope=bot)\n[GitHub](https://github.com/mr_jaxee/effective_bot)\n[Our support server](https://discord.gg/QbQ8qs4jDz)' # 1.15.7
            ],
            [ # 1.16
              'Polling', # 1.16.0
              '', # 1.16.1
