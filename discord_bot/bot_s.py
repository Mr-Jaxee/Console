...
async def on_ready():
    ...
    res = requests.post("https://api.server-discord.com/v2/bots/816344485138923541/stats", headers={'Content-Type':'application/json',
...
async def on_message(message):
  if message.content.startswith(botconfig['prefix']):
    text = 'В работе бота произошли технические неполадки, мы разберемся с ними. А чтобы не скучать, заходите на наш [саппорт-сервер](https://discord.gg/QbQ8qs4jDz).\n\n**Приносим свои извинения за доставленные неудобства!**'
